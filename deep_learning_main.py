"""
https://gist.github.com/awjuliani/86ae316a231bceb96a3e2ab3ac8e646a
"""
...
# running the environment (10 times) taking random actions
def random_actions():
    reward_sum = 0
    episode_n = 0
    while episode_n < 10:
        ...
        reward_sum += reward
        if done:  # game over, the pole has fallen (LOSE) OR reward == 200 (WIN)
            episode_n += 1
            print(episode_n, ") Reward for this episode was:", reward_sum)
            reward_sum = 0
            env.reset()
...
# train a neural network agent (reinforcement learning)
